...
2. **Load Convention Reference**: Read `.claude/skills/backend-test-layer.md` to extract all test convention rules. Focus on sections:
   - 레이어별 어노테이션 (섹션 1)
   - 테스트 네이밍 규칙 (섹션 2)
...
2. Read .claude/skills/backend-test-layer.md conventions
3. Locate PLAN file
